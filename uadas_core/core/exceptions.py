# File: uadas_core/core/exceptions.py
...
class ApplicationStateError(ApplicationError):
    ...
    For example, asking :class:`~uadas_core.core.application_state.
...
class ReaderError(ApplicationError):
    ...
    :mod:`uadas_core.readers.base_reader` for the reader interface that
    raises this.
    """
