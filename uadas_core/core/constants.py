# File: uadas_core/core/constants.py
...
file's own location (three parents up: uadas_core/core/constants.py ->
uadas_core/core -> src -> project root) rather than from ``Path.cwd()``, so
...
# Path anchors
# --------------------------------------------------------------------------
# constants.py -> uadas_core/core -> src -> project root
...
# Must stay in step with uadas_core.theme.tokens.TOKENS_BY_NAME. It is duplicated
