# File: uadas_core/plugins/plugin_manager.py
...
from uadas_core.cleaning.operation_registry import unregister_operation
from uadas_core.core.logger import get_logger
from uadas_core.plugins.plugin_loader import LoadedPlugin, discover_plugins
from uadas_core.readers.reader_registry import unregister_reader
from uadas_core.visualization.chart_registry import unregister_chart
...
class PluginManager:
    ...
    Args:
        search_paths: Directories to scan for plugins — normally
            :attr:`~uadas_core.core.config.AppConfig.plugin_search_paths`.
        enabled: Whether plugin loading is turned on at all — normally
            :attr:`~uadas_core.core.config.AppConfig.plugins_enabled`. When
