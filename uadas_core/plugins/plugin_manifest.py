# File: uadas_core/plugins/plugin_manifest.py
...
strings — :class:`~uadas_core.plugins.plugin_loader.PluginLoader` imports each
...
# Base* shape at all (see uadas_core.forecasting's own modules), and
...
class PluginManifest:
    ...
    Attributes:
        ...
        manifest_path: Where this manifest was loaded from — kept so
            :class:`~uadas_core.plugins.plugin_loader.PluginLoader` can
