# File: uadas_core/plugins/plugin_loader.py
...
from uadas_core.cleaning.operation_registry import register_operation
...
from uadas_core.readers.reader_registry import register_reader
from uadas_core.visualization.base_chart import BaseChart
from uadas_core.visualization.chart_registry import ChartRegistration, register_chart
...
class LoadedPlugin:
    ...
    Attributes:
        ...
        registered_classes: Category -> list of the actual classes
            ...
            ``registered`` — what
            :class:`~uadas_core.plugins.plugin_manager.PluginManager` walks
...
def discover_plugins(
    ...
    Args:
        ...
        skip_names: Plugin names to skip entirely (not even imported) —
            used by :class:`~uadas_core.plugins.plugin_manager.PluginManager`
