# File: uadas_core/readers/reader_registry.py
...
from uadas_core.readers.csv_reader import CsvReader
from uadas_core.readers.excel_reader import ExcelReader
from uadas_core.readers.feather_reader import FeatherReader
from uadas_core.readers.html_reader import HtmlReader
from uadas_core.readers.image_reader import ImageReader
from uadas_core.readers.json_reader import JsonReader
from uadas_core.readers.ods_reader import OdsReader
from uadas_core.readers.parquet_reader import ParquetReader
from uadas_core.readers.pdf_reader import PdfReader
from uadas_core.readers.powerpoint_reader import PowerPointReader
from uadas_core.readers.sqlite_reader import SqliteReader
from uadas_core.readers.text_reader import TextReader
from uadas_core.readers.word_reader import WordReader
from uadas_core.readers.xml_reader import XmlReader
...
def register_reader(reader_class: type[BaseReader]) -> None:
    ...
    Args:
        reader_class: A :class:`~uadas_core.readers.base_reader.BaseReader`
            subclass.
...
def unregister_reader(reader_class: type[BaseReader]) -> None:
    ...
    :func:`~uadas_core.visualization.chart_registry.unregister_chart`. Built-
