# File: uadas_core/readers/ods_reader.py
"""Reads OpenDocument Spreadsheet (.ods) files into a Dataset.

Same multi-table shape as :class:`~uadas_core.readers.excel_reader.
    ...
    def read(cls, path: Path, table_name: str | None = None) -> Dataset:
        ...
        Args:
            ...
            table_name: Which sheet to read, by name. See
                :meth:`~uadas_core.readers.excel_reader.ExcelReader.read`'s
