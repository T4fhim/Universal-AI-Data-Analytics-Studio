# File: uadas_core/readers/sqlite_reader.py
...
candidate for :meth:`~uadas_core.readers.base_reader.BaseReader.list_tables`
and :meth:`~uadas_core.readers.base_reader.BaseReader.read`'s ``table_name``
argument, following the same contract
:class:`~uadas_core.readers.excel_reader.ExcelReader` implements for Excel
worksheets.
...
:func:`~uadas_core.readers.type_inference.find_ambiguous_type_columns`
