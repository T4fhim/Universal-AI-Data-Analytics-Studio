# File: uadas_core/readers/excel_reader.py
...
:mod:`uadas_core.readers.base_reader`'s module docstring for the general
multi-table contract (:meth:`~uadas_core.readers.base_reader.BaseReader.
list_tables`, the ``table_name`` parameter on
:meth:`~uadas_core.readers.base_reader.BaseReader.read`) this reader is the
