# File: uadas_core/readers/parquet_reader.py
...
delimiter-sniffing analog to :class:`~uadas_core.readers.csv_reader.
CsvReader`'s concerns, and no header-row ambiguity like
:class:`~uadas_core.readers.excel_reader.ExcelReader`'s — the file's own
