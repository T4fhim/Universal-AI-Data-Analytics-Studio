# File: uadas_core/readers/html_reader.py
"""Reads ``<table>`` elements from an HTML file into a Dataset.

Multi-table, the same conceptual shape as
:class:`~uadas_core.readers.excel_reader.ExcelReader`, except the "tables"
...
header-row convention elsewhere in :mod:`uadas_core.readers`.
"""
