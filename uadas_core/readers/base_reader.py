# File: uadas_core/readers/base_reader.py
...
* :meth:`list_tables` — added in milestone 2b, when Excel and SQLite
  ...
  offer (see :mod:`uadas_core.readers.excel_reader`,
  :mod:`uadas_core.readers.sqlite_reader`) override this method; every other
...
:mod:`uadas_core.readers.csv_reader`, :mod:`uadas_core.readers.json_reader`, and
:mod:`uadas_core.readers.text_reader` for milestone 2a's three single-table
readers; :mod:`uadas_core.readers.excel_reader` and
:mod:`uadas_core.readers.sqlite_reader` for milestone 2b's two multi-table
readers; and :mod:`uadas_core.readers.reader_registry` for the dispatcher
...
class BaseReader(ABC):
    ...
    :mod:`uadas_core.readers.reader_registry`, which holds reader *classes*,
    ...
    :mod:`uadas_core.readers.reader_registry` to build a useful "supported
    ...
    def can_read(cls, path: Path) -> bool:
        ...
        :mod:`uadas_core.readers.reader_registry`) may call this across many
    ...
    def list_tables(cls, path: Path) -> list[str]:
        ...
        (:class:`~uadas_core.readers.excel_reader.ExcelReader`,
        :class:`~uadas_core.readers.sqlite_reader.SqliteReader`) override
    ...
    def read(cls, path: Path, table_name: str | None = None) -> Dataset:
        ...
        Args:
            ...
            table_name: For multi-table readers, which table (sheet
                ...
                :class:`~uadas_core.core.exceptions.ReaderError` naming the
