# File: uadas_core/services/settings_service.py
"""Runtime settings access and persistence, distinct from startup config loading.

:class:`~uadas_core.core.config.AppConfig` (built in milestone 1a) is a
...
from uadas_core.core.constants import CONFIG_FILE_PATH
...
class SettingsService:
    ...
    Args:
        initial_config: The :class:`~uadas_core.core.config.AppConfig`
    ...
    def save(self) -> None:
        ...
        Raises:
            ConfigError: If the current in-memory settings no longer
                ...
                file :func:`~uadas_core.core.config.load_config` would then
