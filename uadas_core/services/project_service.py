# File: uadas_core/services/project_service.py
...
class ProjectService:
    ...
    Args:
        recent_projects: Initial list of recent project paths (as
            ...
            :class:`~uadas_core.core.config.AppConfig`'s
            ...
            :mod:`uadas_core.services.settings_service`), not this service's
    ...
    def get_active_project(self) -> Project | None:
        ...
        :class:`~uadas_core.core.application_state.ApplicationState`'s
    ...
    def record_analysis_log(
        ...
        """Record one dataset's :class:`~uadas_core.services.analysis_orchestrator_service.AnalysisLog`.
        ...
        Args:
            ...
            log_dict: The already-serialized log (typically
                ...
                ``uadas_core.services.analysis_orchestrator_service`` (or
                ``uadas_core.services.workspace_service``), keeping every
