# File: uadas_core/services/analysis_orchestrator_service.py
...
already registered in :mod:`uadas_core.ai.tool_registry`, the same tools the
AI chat (:mod:`uadas_core.ai.assistant_service`) already calls, so a stage run
...
class AnalysisLogEntry:
    ...
    Attributes:
        ...
        tool_name: The :class:`~uadas_core.ai.tool_registry.ToolDefinition`
            name that was run, or ``None`` for an EXPLAIN entry (which
            records an :class:`~uadas_core.analysis.explanation.Explanation`
        ...
        explanation: The stage's :class:`~uadas_core.analysis.explanation.
...
class AnalysisOrchestratorService:
    ...
    def propose_next_stage(self, dataset_id: str) -> StageProposal:
        ...
        wiring in a live :class:`~uadas_core.ai.assistant_service.
    ...
    def run_stage(
        ...
        Args:
            ...
            tool_name: Which :mod:`uadas_core.ai.tool_registry` tool to run.
        ...
        Raises:
            ServiceError: If ``dataset_id`` is not registered in
                ...
                the way :meth:`~uadas_core.ai.assistant_service.
        ...
        # check needed here, unlike uadas_core.ai.assistant_service's
    ...
    def _summarize_result(
        ...
        Mirrors :meth:`~uadas_core.ai.assistant_service.AssistantService.
