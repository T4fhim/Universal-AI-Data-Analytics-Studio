# File: uadas_core/analysis/chi_square.py
"""Chi-square test of independence between two categorical columns, via scipy.

Reuses :func:`~uadas_core.analysis.crosstab.cross_tabulate`'s contingency
table for the same reason
:func:`~uadas_core.forecasting.model_comparison.compare_forecast_models`
reuses :mod:`~uadas_core.forecasting.forecast_input`: the contingency table
...
class ChiSquareResult:
    ...
    Attributes:
        ...
        contingency_table: The observed-frequency contingency table
            ...
            :func:`~uadas_core.analysis.crosstab.cross_tabulate` returns.
...
def chi_square_test(
    ...
    Raises:
        ServiceError: Propagated from
            :func:`~uadas_core.analysis.crosstab.cross_tabulate` if the
