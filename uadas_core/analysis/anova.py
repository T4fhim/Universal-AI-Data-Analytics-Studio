# File: uadas_core/analysis/anova.py
"""One-way ANOVA (analysis of variance) across 3+ groups, via scipy.

Complements :mod:`~uadas_core.analysis.t_test`: a t-test compares exactly two
...
def one_way_anova(
    ...
    Raises:
        ServiceError: If a named column does not exist, ``value_column``
            ...
            :func:`~uadas_core.analysis.t_test.independent_t_test` instead),
