# File: uadas_core/analysis/column_profile.py
"""Per-column profiling: type, missingness, uniqueness, and type-appropriate statistics.

:func:`profile_column` reuses
:func:`~uadas_core.readers.type_inference.find_ambiguous_type_columns` rather
...
class ColumnProfile:
    ...
    Attributes:
        ...
        is_ambiguous_type: Whether this column was flagged by
            :func:`~uadas_core.readers.type_inference.
...
def profile_column(
    ...
    Args:
        ...
        ambiguous_columns: Pre-computed result of
            ...
            :func:`~uadas_core.analysis.dataset_profile.profile_dataset`
