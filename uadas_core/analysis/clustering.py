# File: uadas_core/analysis/clustering.py
"""K-means clustering, via scikit-learn.

Standardizes columns before fitting for the same reason
:mod:`~uadas_core.analysis.pca` does — unscaled columns with larger numeric
...
selection as :mod:`~uadas_core.analysis.correlation` and :mod:`~uadas_core.analysis.pca`.
"""
...
def k_means_clustering(
    ...
    Args:
        ...
        random_state: Seed for k-means' centroid initialization, for
            ...
            data — matches
            :mod:`~uadas_core.forecasting.model_comparison`'s holdout split
