# File: uadas_core/analysis/regression.py
...
CLAUDE.md's :class:`~uadas_core.analysis.explanation.Explanation` shape and
...
:mod:`~uadas_core.forecasting.linear_regression_forecast`, which uses the
same underlying model for a different purpose (projecting a time
series forward) with a different result shape
(:class:`~uadas_core.forecasting.exponential_smoothing.ForecastResult`).
"""
