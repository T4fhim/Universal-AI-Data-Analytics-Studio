# File: uadas_core/analysis/pca.py
...
:func:`~uadas_core.readers.type_inference.find_ambiguous_type_columns` and
the same numeric-column-selection logic as
:mod:`~uadas_core.analysis.correlation`, for the same reason: an
...
def compute_pca(
    ...
    Args:
        ...
        columns: Which columns to include. If omitted, every
            ...
            :func:`~uadas_core.analysis.correlation.compute_correlation` uses.
