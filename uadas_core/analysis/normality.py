# File: uadas_core/analysis/normality.py
...
:mod:`~uadas_core.analysis.t_test`/:mod:`~uadas_core.analysis.anova` because
...
:mod:`~uadas_core.forecasting.forecast_input`'s validation separate from the
