# File: uadas_core/analysis/correlation.py
"""Correlation matrix for numeric columns, excluding ambiguous-type columns.

Reuses :func:`~uadas_core.readers.type_inference.find_ambiguous_type_columns`
for the same reason :mod:`~uadas_core.analysis.dataset_profile` does — a
