# File: uadas_core/analysis/dataset_profile.py
...
class DatasetProfile:
    ...
    Attributes:
        ...
        duplicate_row_count: Rows that are exact duplicates of an
            earlier row (see :class:`~uadas_core.cleaning.duplicates.
        ...
        column_profiles: One :class:`~uadas_core.analysis.column_profile.
