# File: uadas_core/visualization/chart_recommender.py
...
milestone 11 plan. Reuses :func:`~uadas_core.analysis.column_profile.profile_column`
...
reuse in this milestone (:mod:`~uadas_core.analysis.chi_square` reusing
``cross_tabulate``, :class:`~uadas_core.visualization.advanced_charts.HeatmapChart`
...
from uadas_core.analysis.column_profile import profile_column
...
class ChartSuggestion:
    ...
    Attributes:
        chart_type: A :mod:`~uadas_core.visualization.chart_registry` key
            (lowercase, underscore-separated -- e.g. ``"box_plot"``),
            resolvable via :func:`~uadas_core.visualization.chart_registry.get_chart`.
            ...
            normalization :func:`~uadas_core.visualization.chart_registry.
