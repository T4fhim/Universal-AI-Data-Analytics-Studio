# File: uadas_core/ai/provider_rotation.py
...
:mod:`uadas_core.ai.assistant_service` holds, per the milestone plan's own
wording — kept in its own module rather than folded directly into
:class:`~uadas_core.ai.assistant_service.AssistantService` because rotation
...
from uadas_core.ai.llm_provider import BaseLLMProvider, create_provider
...
def _looks_like_rate_limit(exc: Exception) -> bool:
    ...
    Every provider in :mod:`uadas_core.ai.llm_provider` wraps its SDK's raw
