# File: uadas_core/ai/tool_registry.py
...
milestone — :mod:`uadas_core.cleaning`, :mod:`uadas_core.analysis`,
:mod:`uadas_core.forecasting`. This means every validation path those
...
def _build_chart(
    ...
    ``BaseChart.build()`` implementation — :meth:`~uadas_core.ai.
