# File: uadas_core/ai/llm_provider.py
...
Rather than let :class:`~uadas_core.ai.assistant_service.AssistantService`
...
class PendingToolCall:
    ...
    Attributes:
        call_id: Provider-specific identifier for this call, needed
            ...
            :class:`~uadas_core.ai.assistant_service.AssistantService`'s loop
