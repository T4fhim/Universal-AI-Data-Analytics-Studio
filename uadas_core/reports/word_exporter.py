# File: uadas_core/reports/word_exporter.py
"""Static Word (.docx) report exporter via python-docx.

Same document-assembly shape as :class:`~uadas_core.reports.pdf_exporter.
...
:func:`~uadas_core.reports.rasterize.figure_to_png_bytes`, same as the PDF
