# File: uadas_core/reports/rasterize.py
"""Shared Plotly-figure-to-PNG-bytes helper for every non-HTML report exporter.

:class:`~uadas_core.reports.pdf_exporter.PdfReportExporter`,
:class:`~uadas_core.reports.word_exporter.WordReportExporter`, and
:class:`~uadas_core.reports.excel_exporter.ExcelReportExporter` have no notion
of an interactive widget the way :class:`~uadas_core.reports.html_exporter.
