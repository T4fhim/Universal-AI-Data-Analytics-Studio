# File: uadas_core/cleaning/text_normalization.py
"""Trim whitespace and normalize casing on text columns.

Unlike :mod:`~uadas_core.cleaning.missing_values` and
:mod:`~uadas_core.cleaning.duplicates`, :class:`NormalizeText` requires an
...
:func:`~uadas_core.readers.type_inference.find_ambiguous_type_columns`'s
