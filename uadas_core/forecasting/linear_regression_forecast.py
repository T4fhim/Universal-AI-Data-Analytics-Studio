# File: uadas_core/forecasting/linear_regression_forecast.py
...
:mod:`~uadas_core.forecasting.exponential_smoothing` and
:mod:`~uadas_core.forecasting.prophet_forecast`, this method assumes the
...
:mod:`~uadas_core.forecasting.model_comparison`) for series that genuinely
