# File: uadas_core/forecasting/prophet_forecast.py
"""Prophet-based forecast.

Better than :mod:`~uadas_core.forecasting.exponential_smoothing` for longer
