# File: uadas_core/forecasting/arima_forecast.py
...
forecasters (:mod:`~uadas_core.forecasting.exponential_smoothing`,
:mod:`~uadas_core.forecasting.prophet_forecast`) also avoid asking the AI
