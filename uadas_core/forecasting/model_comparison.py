# File: uadas_core/forecasting/model_comparison.py
...
user (or the AI) guessing which of :func:`~uadas_core.forecasting.
exponential_smoothing.forecast_exponential_smoothing` or
:func:`~uadas_core.forecasting.prophet_forecast.forecast_prophet` fits a given
...
# defaulted, matching how uadas_core.ai.tool_registry's forecast tools also
...
class ModelCandidateResult:
    ...
    Attributes:
        method: Matches :attr:`~uadas_core.forecasting.exponential_smoothing.
...
def compare_forecast_models(
    ...
    Args:
        ...
        progress_callback: Optional ``(percent, message)`` callable
            ...
            genuinely slow operation :mod:`uadas_core.forecasting` exposes,
    ...
    Raises:
        ServiceError: If the series fails
            :func:`~uadas_core.forecasting.forecast_input.validate_time_series`,
