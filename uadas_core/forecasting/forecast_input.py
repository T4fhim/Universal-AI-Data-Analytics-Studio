# File: uadas_core/forecasting/forecast_input.py
"""Shared time-series input validation for both forecasting methods.

Both :mod:`~uadas_core.forecasting.exponential_smoothing` and
:mod:`~uadas_core.forecasting.prophet_forecast` need a genuinely time-ordered
